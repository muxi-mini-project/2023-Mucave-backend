...
func Register(r *gin.Engine) {
	...
	u.Use(Midware.TokenMiddleWare)
	{
		...
		u.GET("/private_msg/:id", user.PrivateMsg)      //刷新某人的来信  delete
		u.GET("/all_private_msg", user.AllPrivateMsg)   //刷新所有给我的私信  delete
		u.POST("/private_msg/:id", user.PrivateMsgSend) //给某人发信息   delete
